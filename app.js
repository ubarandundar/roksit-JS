...
const Iller = document.querySelector('#Iller');
const pIller = document.querySelector('#p-iller');
Iller.addEventListener('input', function () {
    pIller.innerText = this.value;
});

const Ilceler = document.querySelector('#Ilceler');
const pIlceler = document.querySelector('#p-ilceler');
Ilceler.addEventListener('input', function () {
    pIlceler.innerText = this.value;
});

const postaKodu = document.querySelector('#posta-kodu');
const pPostaKodu = document.querySelector('#p-posta-kodu');
postaKodu.addEventListener('input', function () {
    pPostaKodu.innerText = this.value;
});
...
const adres2 = document.querySelector('#adres-2');
const pAdres2 = document.querySelector('#p-adres-2');
adres2.addEventListener('input', function () {
    pAdres2.innerText = this.value;
});
...
const descriptionCell = document.querySelectorAll('#preview div');
deleteButton.addEventListener('click', function () {
    mainForm.reset();
    for (let i = 0; i < descriptionCell.length; i++) {
        descriptionCell[i].innerText = "";
    }
});
...
for (let i = 0; i < data.length; i++) {
    ...
    opt.value = data[i].il;
    opt.innerText = data[i].il;
    iller.append(opt);
}

iller.addEventListener('change', function () {
    ilceler.removeAttribute('disabled');
    ilceler.innerHTML = '';
    for (let i = 0; i < data.length; i++) {
